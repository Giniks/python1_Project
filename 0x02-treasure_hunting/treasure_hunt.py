...
choice1 = input("Where do you want to go? Type right or left: ").lower()
if choice1 == 'left':
  print("Welcome to a tropical rainforest, you are now lost forever, Game Over!")
  exit()
elif choice1 == 'right':
  choice2 = input("Welcome to an endless ocean, you see a boat in the distance, do you want to wait or swim? ").lower()
  if choice2 == 'wait':
    print("You chose wait, let's see what happens next!")
    print("Here is your boat! Off you go!")
    choice3 = input("Welcome to the island, you see a house with 3 doors, a red one, a blue one and a yellow one, which one do you choose? ").lower()
    if choice3 == 'red':
